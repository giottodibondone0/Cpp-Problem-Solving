...
vector<stClientData> LoadClientsFromFile(const string& FileName, const string& Separator = " ") {
...
void FindDataInStruct(const string& FileName, const string& Separator = " ") {
    string AccountNumber;
    cin >> AccountNumber;

    vector<stClientData> clients;
    clients = LoadClientsFromFile(FileName,Separator);
